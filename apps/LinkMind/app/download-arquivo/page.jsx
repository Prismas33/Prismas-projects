      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div className="relative mb-4">
            ...
            <input
              type="text"
              placeholder="Buscar por nome, conteúdo ou categoria do arquivo..."
              value={busca}
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-800">              {busca ? `Resultados para "${busca}"` : "Todos os seus arquivos"}
          ...
          {carregando ? (
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">              {resultados.map((arquivo) => (
                <CardArquivo key={arquivo.id || Math.random()} arquivo={arquivo} />
              ))}
            </div>
          ) : (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-700 mb-2">                {busca ? "Nenhum resultado encontrado" : "Ainda não tem arquivos guardados"}
              </h3>
              <p className="text-gray-500 mb-4">
                {busca 
                  ? "Tente usar palavras-chave diferentes ou remover os filtros." 
                  : "Comece a fazer upload dos seus arquivos mentais para os poder encontrar aqui."
                }
              </p>
              {!busca && (
                <Link 
